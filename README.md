...
3. **Patrón por filas** — instrucciones por fila; pegar texto; editar; leer en voz alta
...
11. **Contador** — vueltas + puntos, meta, marcadores con nombre, pantalla completa; la pantalla no se apaga al tejer
